...
module cla4(
  ...
  and #(2) g_tc1_1 (t_c1_1, p0, cin);
  or  #(2) g_c1    (c1, g0, t_c1_1);

  and #(2) g_tc2_1 (t_c2_1, p1, g0);
  and #(2) g_tc2_2 (t_c2_2, p1, p0, cin);
  or  #(2) g_c2    (c2, g1, t_c2_1, t_c2_2);

  and #(2) g_tc3_1 (t_c3_1, p2, g1);
  and #(2) g_tc3_2 (t_c3_2, p2, p1, g0);
  and #(2) g_tc3_3 (t_c3_3, p2, p1, p0, cin);
  or  #(2) g_c3    (c3, g2, t_c3_1, t_c3_2, t_c3_3);

  and #(2) g_tc4_1 (t_c4_1, p3, g2);
  and #(2) g_tc4_2 (t_c4_2, p3, p2, g1);
  and #(2) g_tc4_3 (t_c4_3, p3, p2, p1, g0);
